...
module.exports = {
    ...
    clearDeviceDisconnectedListener: function () {
        cordova.exec(null, null, "BluetoothClassicSerial", "clearDeviceDisconnectedListener", []);
    },
    setDeviceDisconnectedListener: function (notify) {
        if (typeof notify != 'function')
            throw 'BluetoothClassicSerial.setDeviceDisconnectedListener: Callback not a function';

        cordova.exec(notify, null, "BluetoothClassicSerial", "setDeviceDisconnectedListener", []);
    },
